    ...
    <div class="flex flex-col md:flex-row items-center gap-10 w-full max-w-4xl mx-auto p-4">
        ...
        <div class="flex-1 bg-white rounded-[2.5rem] shadow-2xl p-10 max-w-md w-full">
            ...
            <form action="../controllers/auth/signup.php" method="POST" class="space-y-5">
                <div class="flex gap-3">
                    <div class="flex-1">
                        ...
                        <input type="text" name="first_name" required class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#55A9FF] focus:border-[#55A9FF] placeholder-gray-400" placeholder="first name">
                    </div>
                    <div class="flex-1">
                        <label class="block text-gray-700 mb-1 text-sm">Last Name</label>
                        <input type="text" name="last_name" required class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#55A9FF] focus:border-[#55A9FF] placeholder-gray-400" placeholder="last name">
                    </div>
                </div>
                <div>
                    <label class="block text-gray-700 mb-1 text-sm">Email</label>
                    <input type="email" name="email" required class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#55A9FF] focus:border-[#55A9FF] placeholder-gray-400" placeholder="your email">
                </div>
                <div>
                    ...
                    <div class="flex">
                        ...
                        <input type="text" name="phone" required class="w-full px-4 py-3 border border-gray-200 border-l-0 rounded-r-xl focus:outline-none focus:ring-2 focus:ring-[#55A9FF] focus:border-[#55A9FF] placeholder-gray-400" placeholder="">
                    </div>
                </div>
                <div class="flex gap-3">
                    <div class="flex-1">
                        <label class="block text-gray-700 mb-1 text-sm">Password</label>
                        <input type="password" name="password" required class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#55A9FF] focus:border-[#55A9FF] placeholder-gray-400" placeholder="your password">
                    </div>
                    <div class="flex-1">
                        <label class="block text-gray-700 mb-1 text-sm">Confirm Password</label>
                        <input type="password" name="confirm_password" required class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#55A9FF] focus:border-[#55A9FF] placeholder-gray-400" placeholder="Confirm Password">
                    </div>
                </div>
                <button type="submit" class="w-full bg-[#55A9FF] hover:bg-[#3d94f5] text-white px-6 py-3 rounded-xl font-bold text-lg shadow mt-2 transition">Sign in</button>
            </form>
            ...
            <div class="text-center text-gray-500 text-base">
                Already have an account? <a href="login.php" class="text-[#55A9FF] hover:text-[#3d94f5] font-semibold hover:underline">Log in</a>
            </div>
        </div>
    </div>
</body>
