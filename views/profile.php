...
function render_main() {
    global $user, $designs, $saved_designs;
?>
<div class="flex-1 flex flex-col px-8 py-8 bg-gray-50 min-h-screen">
    <div class="max-w-3xl mx-auto">
        ...
        <div class="flex items-center bg-white rounded-xl shadow p-6 mb-8">
            <img src="https://randomuser.me/api/portraits/lego/1.jpg" class="w-20 h-20 rounded-full border-4 border-white shadow mr-6" alt="User">
            <div class="flex-1">
