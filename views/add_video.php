...
function render_main() {
    ...
    <div class="flex flex-col items-center justify-center min-h-screen py-10 px-4 bg-gray-50">
        <div class="bg-white rounded-lg shadow-lg p-8 w-full max-w-md">
            <h1 class="text-2xl font-bold text-purple-700 mb-6 text-center">Upload a Video</h1>
            ...
            <form action="../controllers/add_video.php" method="POST" enctype="multipart/form-data" class="space-y-4">
                <div>
                    ...
                    <select name="offer_id" required class="w-full border rounded px-3 py-2 bg-white">
                ...
                <div>
                    ...
                    <input type="file" name="video_file" accept="video/mp4,video/webm,video/mov" required class="w-full border rounded px-3 py-2" />
                </div>
                <div>
                    <label class="block text-gray-700 font-semibold mb-1">Description</label>
                    <textarea name="description" rows="3" class="w-full border rounded px-3 py-2" placeholder="Describe your video..."></textarea>
                </div>
                <button type="submit" class="w-full bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 rounded transition">Upload Video</button>
            </form>
        </div>
    </div>
    <?php
