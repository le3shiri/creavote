...
<div class="flex-1 flex flex-col px-8 py-8">
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="create-offer.php" class="bg-[#55A9FF] hover:bg-[#3d94f5] text-white font-semibold px-5 py-2 rounded-lg shadow transition-colors">+ Create Offer</a>
    </div>
    <div class="mb-8">
        <form class="flex items-center w-full max-w-xl">
            <input type="text" placeholder="Search offers" class="flex-1 px-4 py-2 border rounded-l-lg focus:outline-none focus:ring-2 focus:ring-[#55A9FF] focus:border-[#55A9FF] bg-white transition-colors">
            <button type="submit" class="bg-[#55A9FF] hover:bg-[#3d94f5] text-white px-4 py-2 rounded-r-lg font-semibold transition-colors">Search</button>
        </form>
    </div>
        ...
        <?php if ($offers): ?>
            <?php foreach ($offers as $offer): ?>
                <div class="bg-white rounded-lg shadow p-5 flex flex-col md:flex-row items-center md:items-start">
                    <div class="flex-1">
                        <a href="offer-details.php?id=<?php echo $offer['offer_id']; ?>" class="font-bold text-lg mb-1 text-[#55A9FF] hover:underline hover:text-[#3d94f5] transition-colors"><?php echo htmlspecialchars($offer['offer_title']); ?></a>
